...
public class OpenUndertaleBattleS2CPacket {
    ...
    public OpenUndertaleBattleS2CPacket(int entityId, String mobName, float mobHealth, float mobMaxHealth, boolean isFrisk) {
    ...
    public boolean handle(Supplier<NetworkEvent.Context> supplier) {
        ...
        context.enqueueWork(() -> {
            Minecraft.getInstance().setScreen(new UndertaleBattleScreen(entityId, mobName, mobHealth, mobMaxHealth, isFrisk));
        });
        return true;
    }
}
